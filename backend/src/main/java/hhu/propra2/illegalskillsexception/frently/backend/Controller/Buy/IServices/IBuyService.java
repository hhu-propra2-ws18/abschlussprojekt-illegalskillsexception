...
public interface IBuyService {
    ...
    void buyItem(Long sellArticleID, ApplicationUser buyer) throws NoSuchBuyArticleException, ProPayConnectionException, InsufficientFundsException, UserNotFoundException;
