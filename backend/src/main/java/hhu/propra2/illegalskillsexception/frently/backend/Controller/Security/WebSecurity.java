...
import static hhu.propra2.illegalskillsexception.frently.backend.Controller.Security.SecurityConstants.*;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurity(SecurityUserService userDetailsService, BCryptPasswordEncoder bCryptPasswordEncoder) {
